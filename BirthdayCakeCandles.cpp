//Link to the problem: https://www.hackerrank.com/challenges/birthday-cake-candles/problem?isFullScreen=true
...
int birthdayCakeCandles(vector<int> candles) {
    int n=candles.size(),biggest=0;
    for(int i=0;i<n;i++){
        biggest = max(biggest,candles[i]);
    }
    int count = 0;
    for(int i=0;i<n;i++){
